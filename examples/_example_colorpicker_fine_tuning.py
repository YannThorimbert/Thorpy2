"""Here is shown how to fine tune of ColorPicker's appearance and behaviour."""
#tags: colorpicker, color, picker, RGB, ColorPickerRGB, advanced styling, ColorPickerPredefined
