...
* By 'element' we mean any UI element, so widget or component of any type
(e.g. buttons, text input, sliders, etc).<br><br>

* You can read-access an element's rect with : my_element.rect.
Regarding modifications, there are methods for manipulating position an size of the elements,
it is your responsibility not to modify the rect directly.<br><br>


* If you set your element as draggable (e.g. self.set_draggable()),
...
e.g : some_sister_element.set_text("This is a new text", adapt_parent=False).<br><br>
"""
import pygame
from . import sorting
from . import shadows
...
##        self._at_click_outside_params = {}
    ...
    def set_draggable(self, x_axis=True, y_axis=True, cannot_drag_outside=True, cannot_draw_outside=True,
        ...
        """Set whether the element can be dragged by the user.
        ***Optional arguments***
...
##            return style.get_rendered_text(self.text).get_rect().size
    ...
    # def is_time_to_click(self):
    #     loop = loops.get_current_loop()
    #     return loop and loop.user_is_allowed_to_click_again()
...
##            self.rect.height = h
    ...
    def set_special_frames(self, frames):
        """Bypasses the element style to display special frames instead, until the animation is finished.
    ...
    def get_rect(self):
        """Returns the current rect of the element, using its current state."""
